...
import { useDynamicSlideInfo } from '@slidev/client/composables/useSlideInfo'
import { parseSideEditorContent } from '@slidev/client/logic/sideEditor'
import { activeElement, editorHeight, editorWidth, isInputting, showEditor, isEditorVertical as vertical } from '@slidev/client/state'
    ...
    <div class="relative overflow-hidden rounded" style="background-color: var(--slidev-code-background)">
      ...
      <div v-show="tab === 'layout'" class="layout-editor-panel">
        ...
        <div class="lep-actions">
          ...
          >Reset</button>
          <button class="lep-btn lep-btn-primary" @click="editor.saveLayout()">
